...
# ---------- Configuration ----------
USERNAME = "Etornyo"  # Your GitHub Username
...
def main():
    # Fetch data to determine car speed (more commits = faster car!)
    try:
        total = fetch_total_contributions(USERNAME)
    except:
        total = 50 # Fallback
    ...
    svg_content = f"""<svg viewBox="0 0 1000 400" xmlns="http://www.w3.org/2000/svg">
  <rect width="1000" height="400" fill="#0f172a" rx="10"/>
  <defs>
  ...
  <path id="fuji-track" 
        ...
        fill="none" stroke="#ef4444" stroke-width="5" stroke-linejoin="round" stroke-linecap="round">
    <animate attributeName="stroke-opacity" values="1;0.4;1" dur="3s" repeatCount="indefinite" />
  </path>

  <line x1="250" y1="310" x2="250" y2="330" stroke="white" stroke-width="3" />
